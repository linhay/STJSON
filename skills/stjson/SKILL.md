---
name: stjson
description: Skill for working with the STJSON Swift library. Trigger when Codex needs to: (1) read or modify code under Source/STJSON or Source/AnyCodable; (2) create or update Codable and JSON encoding/decoding examples; (3) diagnose or fix tests involving STJSON, AnyCodable, or JSONLines; (4) add migration notes or small API usage snippets for this repository.
---
...
- Reference snippets in `skills/stjson/references/usage.md`
...
6. If asked for usage examples, pull concise snippets from `skills/stjson/references/usage.md`.
